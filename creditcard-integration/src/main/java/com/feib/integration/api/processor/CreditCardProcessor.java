...
public class CreditCardProcessor {
	...
	private final static Logger logger = LoggerFactory.getLogger(CreditCardProcessor.class);
	...
	static {
		...
		List<IVR9013ResponseDetailVO> ivr9013ResponseDetails1 = new ArrayList<IVR9013ResponseDetailVO>();
		...
		List<IVR9013ResponseDetailVO> ivr9013ResponseDetails2 = new ArrayList<IVR9013ResponseDetailVO>();
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO1.getReqUserID() + ivr9014ResponseVO1.getMessageRecNo(), ivr9014ResponseVO1);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO2.getReqUserID() + ivr9014ResponseVO2.getMessageRecNo(), ivr9014ResponseVO2);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO3.getReqUserID() + ivr9014ResponseVO3.getMessageRecNo(), ivr9014ResponseVO3);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO4.getReqUserID() + ivr9014ResponseVO4.getMessageRecNo(), ivr9014ResponseVO4);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO5.getReqUserID() + ivr9014ResponseVO5.getMessageRecNo(), ivr9014ResponseVO5);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO6.getReqUserID() + ivr9014ResponseVO6.getMessageRecNo(), ivr9014ResponseVO6);
		...
		ivr9014ResponseMap.put(ivr9014ResponseVO7.getReqUserID() + ivr9014ResponseVO7.getMessageRecNo(), ivr9014ResponseVO7);
	}
	...
	public IVR9013ResponseVO ivr9013(Exchange exchange) {
		...
		try {
			...
			logger.info("input: {}", jsonString);
			IVR9013RequestVO ivr9013RequestVO = objectMapper.readValue(jsonString, IVR9013RequestVO.class);
			ivr9013ResponseVO = ivr9013ResponseMap.get(ivr9013RequestVO.getId());
		} catch (Exception e) {
			logger.error("error.", e);
		}
		if (null == ivr9013ResponseVO) {
			ivr9013ResponseVO = new IVR9013ResponseVO();
			ivr9013ResponseVO.setTxID("IVR9013");
			ivr9013ResponseVO.setUnitCD("9999");
		}
	...
	public IVR9014ResponseVO ivr9014(Exchange exchange) {
		...
		try {
			...
			String jsonString = objectMapper.writeValueAsString(exchange.getIn().getBody());
			logger.info("input: {}", jsonString);
			IVR9014RequestVO ivr9014RequestVO = objectMapper.readValue(jsonString, IVR9014RequestVO.class);
			ivr9014ResponseVO = ivr9014ResponseMap.get(ivr9014RequestVO.getId() + ivr9014RequestVO.getSeq());
		} catch (Exception e) {
			logger.error("error.", e);
		}
		if (null == ivr9014ResponseVO) {
			ivr9014ResponseVO = new IVR9014ResponseVO();
			ivr9014ResponseVO.setTxnID("IVR9013");
			ivr9014ResponseVO.setUnitCD("9999");
		}
